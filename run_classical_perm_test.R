...
cat(sprintf("[Task %d/200] Running classical finite-sample permutation MW test...\n", i))
...
cat(sprintf("[Task %d/200] Finished classical finite-sample permutation MW test.\n", i))

cat(sprintf("[Task %d/200] Running Besag-Clifford finite-sample permutation MW test...\n", i))
...
cat(sprintf("[Task %d/200] Finished Besag-Clifford finite-sample permutation MW test.\n", i))
